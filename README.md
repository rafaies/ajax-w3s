# AJAX Examples from w3schools.com
...
- [JS AJAX](https://www.w3schools.com/js/js_ajax_intro.asp "JavaScript Tutorial")
  - [JavaScript Fetch API](https://www.w3schools.com/js/js_api_fetch.asp "The Fetch API interface allows web browser to make HTTP requests to web servers")
  - [JS JSON](https://www.w3schools.com/js/js_json_intro.asp "JSON stands for JavaScript Object Notation")
